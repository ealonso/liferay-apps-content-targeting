...
public class UserSegmentLocalServiceClpInvoker {
	public UserSegmentLocalServiceClpInvoker() {
		...
		_methodName94 = "moveUserSegmentToTrash";

		_methodParameterTypes94 = new String[] { "long", "long" };

		_methodName95 = "restoreUserSegmentFromTrash";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName94.equals(name) &&
			...
			return UserSegmentLocalServiceUtil.moveUserSegmentToTrash(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
		}

		if (_methodName95.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes95, parameterTypes)) {
			return UserSegmentLocalServiceUtil.restoreUserSegmentFromTrash(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
		}
